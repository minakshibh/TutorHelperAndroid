...
public class MergeStudentActivity extends Activity implements AsyncResponseForTutorHelper {
	...
	public void onClick(View v) {
		...
		System.err.println("arraylist_student size="+arraylist_student.size());
		...
		if (first_id.length() > 0) {
					if (second_id.length() > 0) {
						...
						try {
							...
							for (int i = 0; i < arraylist_student.size(); i++) {
								...
								String studentid = arraylist_student.get(i).getStudentId();
				...
				if((first_check.equalsIgnoreCase("yes") ))
				{
					if(second_check.equalsIgnoreCase("yes"))
					{
						...
						AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MergeStudentActivity.this);
						...
						{
							Util.alertMessage(MergeStudentActivity.this, "Please enter valid Ids");;
						}
					}
						else
						{
						...
						Util.alertMessage(MergeStudentActivity.this, "Enter second student id");;
						}
				}
		else {
				Util.alertMessage(MergeStudentActivity.this, "Enter first student id");
			}
	...
	private void mergeStudent() {
		if (Util.isNetworkAvailable(MergeStudentActivity.this)){
			...
			AsyncTaskForTutorHelper mLogin = new AsyncTaskForTutorHelper(MergeStudentActivity.this, "merge-parent", nameValuePairs, true, "Please wait...");
			mLogin.delegate = (AsyncResponseForTutorHelper) MergeStudentActivity.this;
			mLogin.execute();
		}else {
			Util.alertMessage(MergeStudentActivity.this,"Please check your internet connection");
		}
	...
	private void fetchStudentList() {
		if (Util.isNetworkAvailable(MergeStudentActivity.this)){
			...
			AsyncTaskForTutorHelper mLogin = new AsyncTaskForTutorHelper(MergeStudentActivity.this, "fetch-student", nameValuePairs, true, "Please wait...");
			mLogin.delegate = (AsyncResponseForTutorHelper) MergeStudentActivity.this;
			mLogin.execute();
		}else {
			Util.alertMessage(MergeStudentActivity.this,"Please check your internet connection");
	...
	public void processFinish(String output, String methodName) {
		TutorHelperParser parser = new TutorHelperParser(MergeStudentActivity.this);
