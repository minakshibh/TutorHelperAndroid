...
public class EditStudentActivity extends Activity implements AsyncResponseForTutorHelper{
	...
	private void setClickListeners() {
		...
		public void onClick(View v) {
			...
			if(check.equals("success"))
			{
				...
				{
					Util.alertMessage(EditStudentActivity.this,"Please check your internet connection");
					}
				}
			else
			{
	...
	public void processFinish(String output, String methodName) {
		...
		{
			AlertDialog.Builder alert = new AlertDialog.Builder(EditStudentActivity.this);
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				if(trigger.equalsIgnoreCase("Parent"))
				{
					Intent i=new Intent(EditStudentActivity.this,MyStudentActivity.class);
					startActivity(i);
					finish();
				}
				else
