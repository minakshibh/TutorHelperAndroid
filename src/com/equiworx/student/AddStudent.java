...
/*		detailcheck =getIntent().getStringExtra("detailadd");
		...
		{
			//parentForm.setVisibility(View.GONE);
			parentSelection.setVisibility(View.VISIBLE);
			//sameAsParent.setVisibility(View.GONE);
	...
	public void onClick(View v) {
			if(v == addParent){
				...
				if(check.equals("success")){
					if (Util.isNetworkAvailable(AddStudent.this)){
						...
						if(trigger.equals("tutor")){
							...
							nameValuePairs.add(new BasicNameValuePair("parent_email", parentEmail.getText().toString().replace(": ", "")));
							nameValuePairs.add(new BasicNameValuePair("parent_contact", parentContact.getText().toString().replace(": ", "")));
							nameValuePairs.add(new BasicNameValuePair("parent_address", parentAddress.getText().toString().replace(": ", "")));
							nameValuePairs.add(new BasicNameValuePair("parent_gender", parentGender));
							nameValuePairs.add(new BasicNameValuePair("address", parentAddress.getText().toString().replace(": ", "")));
				...
				email.setText(parentEmail.getText().toString().replace(": ", ""));
				contactInfo.setText(parentContact.getText().toString().replace(": ", ""));
			}
		}
	};
	...
	/*	else if(trigger!=null)
		{
		 ...
		 if(idcheck==1){
			parentId = tutorPrefs.getString("newparentID", "0");
			//txt_parentid.setText(parentId);
			parentName.setText(" "+tutorPrefs.getString("name", "Parent name"));
