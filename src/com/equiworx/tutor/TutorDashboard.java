...
import com.equiworx.tutorhelper.LoginActivity;
...
public class TutorDashboard extends FragmentActivity implements AsyncResponseForTutorHelper{
	...
	private void getnotification() {
		...
		{	
			...
			Intent intent=new Intent(TutorDashboard.this,NotificationTutorActivity.class);
	...
	private void getTutorDetails(Boolean value) {
		...
		if (Util.isNetworkAvailable(TutorDashboard.this)){
			...
			AsyncTaskForTutorHelper mLogin = new AsyncTaskForTutorHelper(TutorDashboard.this, "getbasicdetail", nameValuePairs, value, "Please wait...");
...
//		}
	   ...
	   private void fetchlParentList(boolean b) {
		if (Util.isNetworkAvailable(TutorDashboard.this)){
			...
			AsyncTaskForTutorHelper mLogin = new AsyncTaskForTutorHelper(TutorDashboard.this, "fetch-parent", nameValuePairs, b, "Please wait...");
			mLogin.delegate = (AsyncResponseForTutorHelper) TutorDashboard.this;
			mLogin.execute();
		}else {
	...
	private View.OnClickListener listener = new View.OnClickListener() {
		public void onClick(View v) {
			if(v == activeStudentsLayout){
				...
				Intent intent = new Intent(TutorDashboard.this, CancellationActivity.class);
				startActivity(intent);
				menuLayoutGone();
				...
				Intent intent = new Intent(TutorDashboard.this, NewsFeedActivity.class);
				startActivity(intent);
			}
		}
	};
...
public void processFinish(String output, String methodName) {
	...
	else if(methodName.equalsIgnoreCase("get-lesson-detail"))
	{
		...
		{
			Util.alertMessage(TutorDashboard.this, "No lessons for this date");
			}
		else
		{
			Intent intent=new Intent(TutorDashboard.this,MyLessonActivity.class);
